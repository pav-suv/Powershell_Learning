function createfolder {
    ...
    param(
        ...
        [Parameter(mandatory=$false)] [string]$FolderName2,
        [Parameter(mandatory=$true)] [string]$FolderName3,
...
createfolder -FolderName1 "Harshithraj Poojary"  -PathName "C:\Automation\Command\"  
